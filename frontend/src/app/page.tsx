    ...
    <div className="min-h-screen bg-[#020617] text-slate-50 font-sans selection:bg-cyan-500/30 overflow-x-hidden">
          ...
          <div className="flex items-center gap-12">
            <Link href="/" className="flex items-center group gap-4">
              ...
              <div className="flex flex-col">
                <span className="text-xl font-black tracking-tighter text-white group-hover:text-cyan-400 transition-colors uppercase italic">WRAITH</span>
      ...
      <main className="relative z-10">
        ...
        <section className="pt-48 pb-32 px-12 text-center">
          ...
          >
            <h1 className="text-[120px] leading-[0.9] font-black tracking-tighter text-white mb-12 uppercase italic">
              DEFEAT THE <br />
        ...
        <section className="py-32 px-12 bg-white/5 border-y border-white/5">
          <div className="max-w-[1440px] mx-auto">
            <div className="mb-20">
              ...
              <h3 className="text-5xl font-black tracking-tight text-white italic uppercase">The Aesthetic of Verifiable Defense</h3>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="space-y-8">
                ...
                <div className="p-8 bg-slate-900/50 rounded-3xl border border-white/5">
                  <h4 className="text-xl font-bold text-white mb-4 italic">Cybernetic Logic</h4>
              ...
              <div className="space-y-8 pt-12">
                ...
                <div className="p-8 bg-slate-900/50 rounded-3xl border border-white/5">
                  <h4 className="text-xl font-bold text-white mb-4 italic">Neural Verification</h4>
                  <p className="text-slate-400 text-sm font-light leading-relaxed">
              ...
              <div className="space-y-8">
                ...
                <div className="p-8 bg-slate-900/50 rounded-3xl border border-white/5">
                  <h4 className="text-xl font-bold text-white mb-4 italic">Financial Precision</h4>
                  <p className="text-slate-400 text-sm font-light leading-relaxed">
        ...
        <section className="py-40 px-12">
          <div className="max-w-[1200px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-24 items-center">
            <div>
              <h2 className="text-6xl font-black tracking-tight text-white mb-12 italic uppercase leading-none">
                Integrated <br />
              ...
              <div className="space-y-12">
                <div className="flex gap-8 group">
                  <div className="w-16 h-16 flex-shrink-0 bg-cyan-500/10 border border-cyan-500/20 rounded-2xl flex items-center justify-center text-cyan-400 group-hover:bg-cyan-500 group-hover:text-black transition-all">
                    <span className="material-symbols-outlined text-3xl italic">psychology</span>
                  </div>
                  <div>
                    <h4 className="text-xl font-bold text-white mb-2 italic">Gensyn AEL (The Brain)</h4>
                ...
                <div className="flex gap-8 group">
                  <div className="w-16 h-16 flex-shrink-0 bg-cyan-500/10 border border-cyan-500/20 rounded-2xl flex items-center justify-center text-cyan-400 group-hover:bg-cyan-500 group-hover:text-black transition-all">
                    <span className="material-symbols-outlined text-3xl italic">shield</span>
                  </div>
                  <div>
                    <h4 className="text-xl font-bold text-white mb-2 italic">Uniswap v4 (The Sword)</h4>
                ...
                <div className="flex gap-8 group">
                  <div className="w-16 h-16 flex-shrink-0 bg-cyan-500/10 border border-cyan-500/20 rounded-2xl flex items-center justify-center text-cyan-400 group-hover:bg-cyan-500 group-hover:text-black transition-all">
                    <span className="material-symbols-outlined text-3xl italic">bolt</span>
                  </div>
                  <div>
                    <h4 className="text-xl font-bold text-white mb-2 italic">Keeper Hub (The Hands)</h4>
            ...
            <div className="relative">
              ...
              <div className="relative aspect-square bg-slate-950 border border-white/10 rounded-[3rem] p-12 flex items-center justify-center overflow-hidden">
                <div className="text-center">
                  <div className="text-8xl font-black text-white mb-4 italic tracking-tighter">1</div>
                  <div className="text-2xl font-bold text-cyan-400 italic uppercase tracking-widest">BLOCK DEFENSE</div>
        ...
        <section className="py-48 px-12 text-center bg-cyan-500 text-black">
          <h2 className="text-[100px] leading-[0.8] font-black tracking-tighter uppercase mb-12 italic">
      ...
      <footer className="py-20 px-12 border-t border-white/5">
        <div className="max-w-[1440px] mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
          <div className="flex items-center gap-4">
            ...
            <div className="text-xl font-black tracking-tighter text-white uppercase italic">WRAITH PROTOCOL</div>
          </div>
